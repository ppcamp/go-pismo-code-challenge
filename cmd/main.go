...
func main() {
	...
	acctService := services.NewAccountService(db, repositories.NewAccount())
	h := &handlers.Handler{
		Account:     acctService,
		Transaction: services.NewTransactionService(db, repositories.NewTransactions(), acctService),
	}
